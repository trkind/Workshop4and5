...
export default class Comment extends React.Component {
  ...
  render() {
    ...
    var numLikes = '';
    if (this.state.likeCounter!=0){
      numLikes = '(' + this.state.likeCounter.length + ')'
    }
    return (
      <div>
        ...
        <div className="media-body">
          ...
          <br /><a href="#" onClick={(e) => this.handleLikeClick(e)}>
            <span className="glyphicon glyphicon-thumbs-up"></span> {likeButtonText} {numLikes}
          </a> · <a href="#">Reply</a> ·
